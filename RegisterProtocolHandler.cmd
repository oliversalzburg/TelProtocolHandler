...
ECHO Windows Registry Editor Version 5.00 > RegisterProtocolHandler.reg
ECHO. >> RegisterProtocolHandler.reg
ECHO [HKEY_CLASSES_ROOT\tel] >> RegisterProtocolHandler.reg
ECHO "URL Protocol"="" >> RegisterProtocolHandler.reg
ECHO @="TEL:Telephone Invocation" >> RegisterProtocolHandler.reg
ECHO. >> RegisterProtocolHandler.reg
ECHO [HKEY_CLASSES_ROOT\tel\shell] >> RegisterProtocolHandler.reg
ECHO. >> RegisterProtocolHandler.reg
